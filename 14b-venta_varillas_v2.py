...
def main():
    ...
    cantidad_vehiculos = calcular_cantidad_vehiculo(
        cantidad_varillas_vendidas, MAXIMA_CAPACIDAD_VEHICULO)
    mensaje = generar_mensaje_venta(cantidad_vehiculos)
    mostrar_mensaje(mensaje)


def calcular_cantidad_vehiculo(cantidad_varillas, maxima_capacidad):
    cantidad_vehiculos = cantidad_varillas//maxima_capacidad
